...
const profile = {
    ...
    title: 'Full-Stack Developer | Code Enthusiast | Problem Solver',
    skills: [
        'React', 'NodeJS', 'Redux', 'Express',
        'MySQL', 'MongoDB', 'CSS', 'AWS', 'JavaScript',
        'Github', 'Git', 'Linux', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    ...
    <>
      <main className="bg-[#020617] text-white min-h-screen">
        ...
        >
          ...
          <div
            className="container mx-auto flex flex-col gap-5 lg:flex-row items-center justify-between relative z-10 py-8 md:py-10 lg:py-12 md:pt-28 xl:pt-28"
            style={{
              paddingTop:
                window.innerWidth >= 1360 &&
                window.innerWidth <= 1370 &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript lover 🚀 | Java lover 🔧 | Crafting frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                <a
                  href="https://github.com/VIRAT178"
